...
import 'package:ytdash_flutter_codex/features/videos/data/repositories/videos_repository_impl.dart'
    as _i573;
import 'package:ytdash_flutter_codex/features/videos/data/services/geocoding_service.dart'
    as _i1048;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i1048.GeocodingService>(
      () => _i1048.GeocodingService(gh<_i519.Client>()),
    );
    ...
    gh.lazySingleton<_i512.VideosRemoteDataSource>(
      () => _i512.VideosRemoteDataSourceImpl(
        gh<_i519.Client>(),
        gh<_i1048.GeocodingService>(),
      ),
    );
