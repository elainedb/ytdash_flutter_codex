...
class VideoModel with _$VideoModel {
  ...
  factory VideoModel.fromDatabase(Map<String, dynamic> map) {
    return VideoModel(
      id: map['id'] as String,
  ...
  Video toEntity() {
    return Video(
      ...
      latitude: latitude,
      longitude: longitude,
      recordingDate: recordingDate == null ? null : DateTime.parse(recordingDate!),
    );
  }

  Map<String, dynamic> toDatabaseMap(DateTime cachedAt) {
